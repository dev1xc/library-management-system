...
Route::prefix('admin')->group(function () {
  Route::get('book-language', [book-languageController::class, 'index']);
  Route::get('add-book-language', [book-languageController::class, 'add']);
  Route::post('add-book-language', [book-languageController::class, 'create']);
  Route::get('edit-book-language/{id}', [book-languageController::class, 'edit']);
  Route::post('edit-book-language/{id}', [book-languageController::class, 'update']);
  Route::get('delete-book-language/{id}', [book-languageController::class, 'delete']);
});
