...
Route::prefix('admin')->group(function () {
  Route::get('book-language', [BookL::class, 'index']);
  Route::get('add-book-language', [BookL::class, 'add']);
  Route::post('add-book-language', [BookL::class, 'create']);
  Route::get('edit-book-language/{id}', [BookL::class, 'edit']);
  Route::post('edit-book-language/{id}', [BookL::class, 'update']);
