...
Route::group(['prefix'=>'user','middleware' => ['user']],function () {
  Route::get('borrow-book', [UseBorrowBookController::class, 'index']);
  Route::get('add-borrow-book', [UseBorrowBookController::class, 'add']);
  Route::post('add-borrow-book', [UseBorrowBookController::class, 'create']);
  Route::get('edit-borrow-book/{id}', [UseBorrowBookController::class, 'edit']);
  Route::post('edit-borrow-book/{id}', [UseBorrowBookController::class, 'update']);
  Route::get('delete-borrow-book/{id}', [UseBorrowBookController::class, 'delete']);
});
