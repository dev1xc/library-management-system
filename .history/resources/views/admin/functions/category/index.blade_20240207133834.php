...
@section('content')
  ...
  <script>
    function deleteCategory(){
      alert('Ban co muon xoa cai nay khong ?')
    }
  </script>
                ...
                <tbody>
                  @foreach ($data as $c)
                    <tr id="{{ $c->id }}">
                      ...
                      <td class="delete"><a href="/admin/delete-category/{{ $c->id }}">Delete</a></td>
                    </tr>
                    <button class="delete" @click='deleteCategory'>Delete</button>
                  @endforeach
