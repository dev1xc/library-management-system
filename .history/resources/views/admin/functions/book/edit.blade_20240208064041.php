          ...
          <div class="card-body">
            <form class="form-horizontal form-material" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" value="{{ $data->name }}" class="form-control form-control-line"
                    name="name">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" value="{{ $data->description }}" class="form-control form-control-line"
                    name="description" id="example-email">
                </div>
              </div>
              <div class="form-group">
                <label for="country" class="col-md-12">Language</label>
                <div class="col-md-12">
                  <select name="id_language" id="Category" class="col-12">
                    @foreach ($dataLanguage as $c)
                      <option value="{{ $c->id }}"
                        @if ($c->id == $data->id_language) @selected(true) @endif>
                        {{ $c->name }}
                      </option>
                    @endforeach
                  </select>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <input type="file" value="{{ $data->image }}" class="form-control form-control-line"
                      name="image" id="example-email">
                  </div>
                </div>
                <div class="form-group">
                  <label for="example-email" class="col-md-12">Page Number</label>
                  <div class="col-md-12">
                    <input type="text" value="{{ $data->page }}" class="form-control form-control-line"
                      name="page" id="example-email">
                  </div>
                </div>
                <div class="form-group">
                  <label for="example-email" class="col-md-12">Book Cover</label>
                  <div class="col-md-12">
                    <input type="text" value="{{ $data->book_cover }}" class="form-control form-control-line"
                      name="book_cover" id="example-email">
                  </div>
                </div>
                <div class="form-group">
                  <label for="example-email" class="col-md-12">Size</label>
                  <div class="col-md-12">
                    <input type="text" value="{{ $data->size }}" class="form-control form-control-line"
                      name="size" id="example-email">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <input type="text" value="{{ $data->author }}" class="form-control form-control-line"
                      name="author" id="password">
                  </div>
                </div>
                <div class="form-group">
                  <label for="phone" class="col-md-12">Price</label>
                  <div class="col-md-12">
                    <input type="text" value="{{ $data->price }}" class="form-control form-control-line"
                      name="price" id="phone">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <input type="text" value="{{ $data->inventory }}" class="form-control form-control-line"
                      name="inventory" id="phone">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <select name="id_category" id="Category" class="col-12">
                      @foreach ($dataCategory as $c)
                        <option value="{{ $c->id }}"
                          @if ($c->id == $data->id_category) @selected(true) @endif>
                          {{ $c->name }}
                        </option>
                      @endforeach
                    </select>
                    ...
                    <div class="col-md-12">
                      <select name="id_publisher" id="Category" class="col-12">
                        @foreach ($dataPublisher as $c)
                          <option value="{{ $c->id }}"
                            @if ($c->id == $data->id_publisher) @selected(true) @endif>
                            {{ $c->name }}
                          </option>
                        @endforeach
                      </select>
