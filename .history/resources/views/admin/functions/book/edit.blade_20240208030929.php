        ...
        <div class="card">
          <div class="card-body">
            <form class="form-horizontal form-material" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label for="phone" class="col-md-12">Language</label>
                <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" value="{{ $data->page }}" class="form-control form-control-line" name="page"
                    id="example-email">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" value="{{ $data->size }}" class="form-control form-control-line" name="size"
                    id="example-email">
                </div>
              </div>
