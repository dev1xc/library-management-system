          ...
          <div class="card-body">
            <form class="form-horizontal form-material" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" value="{{ $data->book_cover }}" class="form-control form-control-line" name="book_cover"
                    id="example-email">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" value="{{ $data->name }}" class="form-control form-control-line" name="inventory"
                    id="phone">
                </div>
              </div>
              <div class="form-group">
