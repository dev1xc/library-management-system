                ...
                <tbody>
                  @foreach ($data as $c)
                    <tr id="{{ $c->id }}">
                      ...
                      <td>{{ $c->name }}</td>
                      <td>{{ $c->description }}</td>
                      <td class="edit"><a href="/admin/edit-book-language/{{ $c->id }}">Edit</a></td>
                      <td class="delete"><a href="/admin/delete-book-laguage/{{ $c->id }}" onclick="returndeleteCategory()">Delete</a></td>
                    </tr>
                    @endforeach
