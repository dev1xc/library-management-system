...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-xlg-3 col-md-5">
            <div class="card">
                <div class="card-body">
                    <center class="m-t-30"> <img src="{{url('/upload/user/avatar/' . ($data -> avatar))}}" class="rounded-circle" width="150" />
                ...
                <div class="card-body">
                    <form class="form-horizontal form-material" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="email" value="{{ $data -> email }}" class="form-control form-control-line" name="email" id="example-email" readonly="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="example-email" class="col-md-12">Address</label>
                            <div class="col-md-12">
                                <input type="text" value="{{ $data -> address }}" class="form-control form-control-line" name="address" id="example-email">
                            </div>
                        </div>
                        <div class="form-group">
