  ...
  <div class="container-fluid">
    ...
    <div class="form-group">
      <div class="col-sm-12">
        ...
        <div class="alert alert-success">Borrowing</div>
        <a href="/admin/borrow-confirm/{{ $dataBorrow->id }}" class="btn btn-danger">Cancle</a>
        @elseif ($dataBorrow->status == 2)
        <div class="alert alert-success">Refund</div>
        <a href="/admin/borrow-confirm/{{ $dataBorrow->id }}" class="btn btn-danger">Refund</a>
        @endif
      </div>
    </div>
    <!-- ============================================================== -->
