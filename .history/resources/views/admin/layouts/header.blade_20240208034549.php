            ...
            <div class="navbar-brand">
                <a href="index.html" class="logo">
                    ...
                    <b class="logo-icon">
                        ...
                        <!-- Dark Logo icon -->
                        <img src="{{ asset('upload/user/avatar/. Auth::user()->image') }}" alt="homepage" class="dark-logo" />
                        <!-- Light Logo icon -->
                        <img src="{{ asset('upload/user/avatar/. Auth::user()->image') }}" alt="homepage" class="light-logo" />
                    </b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
